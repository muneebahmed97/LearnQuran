...
public class FragmentSeen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ivSeen = (ImageView) view.findViewById(R.id.iv_seen);

        ivSeen.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        final MediaPlayer seenSound = MediaPlayer.create(getActivity().getApplicationContext(), R.raw.seen);
