 ...
 */
public class FragmentTaw extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_taw, container, false);

        btnPlay = (Button) view.findViewById(R.id.btn_play);
        btnNext = (Button) view.findViewById(R.id.btn_next);
        btnPrevious = (Button) view.findViewById(R.id.btn_previous);

        ivTaw = (ImageView) view.findViewById(R.id.iv_taw);

        ivTaw.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        final MediaPlayer tawSound = MediaPlayer.create(getActivity().getApplicationContext(), R.raw.tawww);
